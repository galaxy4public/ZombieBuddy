...
// verifies: @MemberHandle on a VarHandle parameter resolves and allows field writes via the parameter
@Patch(className = "testjar.MemberHandleTarget", methodName = "doParamVarHandle")
public class PatchMemberHandleParamVarHandle {
    @Patch.OnEnter
    public static void enter(
            @Patch.MemberHandle(className = "testjar.MemberHandleHelper", type = String.class) VarHandle capturedParamVarHandle
    ) throws Throwable {
