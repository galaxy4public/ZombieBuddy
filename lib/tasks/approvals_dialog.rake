...
def zb_json_entry(h)
  out = {
    ...
    "infAbsolutePath" => h[:inf_path].to_s,
  ...
  3.times.map do |i|
    {
      ...
      inf_path: "/tmp/DemoModOk#{i}/mod.info",
      sha256: hex64,
      date: "2026-01-01",
      ...
      **zbs_signed(first_author)
  ...
  end + [
      {
        ...
        inf_path: "/tmp/DemoModBad/mod.info",
        sha256: "b" * 64,
        date: "2026-01-02",
        decision: nil,
      ...
      },
      {
        ...
        inf_path: "/tmp/DemoModBanned/mod.info",
        sha256: "d" * 64,
        date: "2026-01-03",
        decision: nil,
      ...
      },
      {
        ...
        inf_path: "/tmp/DemoModLegacy/mod.info",
        sha256: "c" * 64,
        date: "2024-12-01",
        decision: nil,
